...
하지만 아두이노 시뮬레이터에서 LED 512 개에 대한 목업을 만들수는 없다.
아두이노의 목업은 한정되어 있어 복잡한 형태의 시뮬레이션은 어렵다.

반면 프로토타입 언어인 JS 와 HTML 에서 제공하는 입력 태그를 이용하면 목업과 테스트 코드를 쉽고 빠르게 만들수 있어 테스트 주도 개발이 편리해진다.
...
### c - Javascript 데이터 주고 받기
* https://github.com/3dgen/cppwasm-book/blob/master/en/ch2-c-js/ch2-04-data-exchange.md
